package com.example.digitron.viewmodel
...
import com.example.digitron.DigitronApplication
import com.example.digitron.data.User
import com.example.digitron.util.RegisterValidation
import com.example.digitron.util.Resource
import com.example.digitron.util.validateEmail
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<DigitronApplication>().contentResolver,
                    imageUri
                )
